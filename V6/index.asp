...
<div id="news">
    <div class="new_l">
        <div class="fl">
            ...
            <iframe src="preview.asp" width="720px" height="204px" scrolling="no" style=" margin-left:-45px; margin-top:-22px;"></iframe>
    ...
    <div class="new_r">
        ...
        <div class="new_r_bg">
            ...
            <div class="fr">
                <img src="imagens/botoes_index4.gif" alt="Redes Sociais" border="0" usemap="#Map" title="Redes Sociais" />
                <map name="Map" id="Map">
                  <area shape="rect" coords="-1,3,33,34" href="http://www.twitter.com/pysidev" target="_blank" alt="Twitter" />
                  <area shape="rect" coords="-11,37,34,73" href="http://www.linkedin.com/companies/pysi-desenvolvimento" target="_blank" />
                </map>
          </div>
            <div class="cb">
            </div>
